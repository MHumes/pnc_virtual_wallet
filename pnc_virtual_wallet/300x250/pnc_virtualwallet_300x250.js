...
//        ACTIVATE FOR SIZMEK
	...
	var loadSpriteSheet = function(){
		var loadedImages = 0;
		imageArr = [
			'logo.png',"applynow.png", "arrow.png", "computer.png", "copy1.png","copy2.png","copy3.png","copy4.png","copy5.png", "mclegal.png"
		];
	...
	var setupElements = function(){
       ...
       $copy3 = document.querySelector('.copy3');
		 $copy4 = document.querySelector('.copy4');
         $copy5 = document.querySelector('.copy5');
	...
	*/
    ...
    var seq1 = function(){
        ...
        setInteractions();
         ...
         $copy4.style.visibility = "visible";
         $copy5.style.visibility = "visible";
       ...
       // t.spriteSheet( $mcHeadline, { 
        ...
        //t.from($footer, 0.75, {top:301, ease:Quart.easeOut, delay:0});

        t.from($copy1, 0.3, {left:301, ease:Quart.easeOut, delay:.75});
        t.delayedCall(1.25, my300Reveal);
     
        t.from($copy3, 0.3, {left:301, ease:Quart.easeOut, delay:1.75});
        t.from($copy4, 0.3, {left:301, ease:Quart.easeOut, delay:1.75});
        t.from($copy5, 0.3, {left:301, ease:Quart.easeOut, delay:1.75, onComplete:seq2});
